...
class GameValidator:
    ...
    def validateSet(self,chosenCards):
        ...
        if (len(Colors) == 3 or len(Colors) == 1) and (len(Fills) == 3 or len(Fills) == 1) and (len(Shapes) == 3 or len(Shapes) == 1) and ((len(Numbers) == 3 or len(Numbers) == 1) ) and (len(chosenCards)==3):
            return True
        else:
            return False
